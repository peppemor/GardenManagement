  ...
  return (
    <section>
      ...
      <p className="info" style={{ marginBottom: "18px" }}>
        Modello base attivo. I campi aggiunti in Impostazioni appaiono qui automaticamente sopra l'ultima riga Secchi/Data Prossimo.
      </p>

      <article className="card" style={{ maxWidth: "880px" }}>
        <div className="card-header" style={{ marginBottom: "12px" }}>
          <h3 style={{ margin: 0 }}>Scheda Template Base</h3>
